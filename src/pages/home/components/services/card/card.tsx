...
const Card: React.FC<CardItemProps> = ({ icon, title, description }) => {
  return (
    <div className="flex cursor-pointer flex-col items-center rounded-lg border-2 border-orange-200 p-6 text-center shadow-sm transition-shadow hover:shadow-lg">
